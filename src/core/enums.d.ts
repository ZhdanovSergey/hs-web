...
export const enum CardTextBuilderType {
	DEFAULT = 0,
	JADE_GOLEM = 1,
...
export const enum DraftSlotType {
	DRAFT_SLOT_NONE = 0,
	DRAFT_SLOT_CARD = 1,
	DRAFT_SLOT_HERO = 2,
...
export const enum DungeonRewardOption {
	INVALID = 0,
	LOOT = 1,
	TREASURE = 2,
	SHRINE_TREASURE = 3,
...
export const enum SwissDeckType {
	SWISS_DECK_NONE = 0,
	SWISS_DECK_CONQUEST = 1,
	SWISS_DECK_LAST_STAND = 2,
}

export const enum TavernBrawlMode {
	TB_MODE_NORMAL = 0,
	TB_MODE_HEROIC = 1,
}

export const enum TournamentState {
	STATE_OPEN = 1,
	STATE_LOCKED = 2,
	STATE_STARTED = 3,
	STATE_CLOSED = 4,
